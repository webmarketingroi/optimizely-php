<?php
/* 
 * This example retrieves all campaigns for the given project from the Optimizely account.
 * 
 ...
 * 
 * Usage: 
 *      php GetCampaigns.php <project_id>
 */
...
// Get projects.
echo "The list of Optimizely campaigns\n";
echo "==================================\n";
echo "\n";
...
try {
    ...
    for (;;) {
        ...
        $result = $optimizelyClient->campaigns()->listAll($projectId, $page, 25);
