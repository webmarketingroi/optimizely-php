<?php
/* 
 * This example retrieves all audiences for the given project from the Optimizely account.
 * 
 ...
 * 
 * Usage: 
 *      php GetAudiences.php <project_id>
 */
...
// Get projects.
echo "The list of Optimizely audiences\n";
echo "==================================\n";
echo "\n";
...
try {
    ...
    for (;;) {
        ...
        $result = $optimizelyClient->audiences()->listAll($projectId, $page, 25);
